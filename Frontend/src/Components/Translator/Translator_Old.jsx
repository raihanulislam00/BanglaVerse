    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-green-light/30 via-white to-red-light/30 p-6">
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="group relative">
            ...
            <div className="flex-1 p-6">
              <textarea
                ...
                className="input-beautiful h-full resize-none border-0 bg-white/80 text-lg"
              />
            </div>
            ...
            <div className="border-t bg-gradient-to-b from-white/0 to-white px-6 py-4">
              <button
                onClick={handleTranslate}
                disabled={loading}
                className="btn-red-primary w-full flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
                    <Loader2 className="h-5 w-5 animate-spin" />
          ...
          {/* Output Panel */}
          <div className="card-beautiful relative flex flex-col overflow-hidden">
            <div className="flex items-center justify-between border-b px-6 py-4 bg-gradient-to-r from-green-light to-white">
              <div className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-green-primary/10 border border-green-primary/20">
            ...
            <div className="flex-1 p-6">
              <div className="h-full rounded-xl bg-gradient-to-b from-green-light/30 to-white/50 p-4 border border-green-primary/10">
                {bangla ? (
                  <p className="text-lg text-gray-800 font-kalpurush leading-relaxed">{bangla}</p>
                ) : (
            ...
            <div className="border-t bg-gradient-to-b from-white/0 to-white px-6 py-4">
              <div className="flex items-center justify-between">
                <button
                  onClick={() => handleCopy(bangla)}
                  disabled={!bangla}
                  className="btn-outline-green flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                >
                  {copied ? <CheckCircle2 className="h-4 w-4 text-green-primary" /> : <Copy className="h-4 w-4" />}
                  {copied ? "Copied!" : "Copy Translation"}
                </button>

                <div className="flex items-center gap-2">
                  <button className="rounded-lg p-2 text-gray-600 hover:text-green-primary transition-all hover:bg-green-light">
      ...
      {/* Error Message */}
      {error && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 rounded-lg bg-red-light border border-red-primary/20 px-6 py-3 text-red-dark shadow-lg backdrop-blur-sm animate-slide-up z-50">
          <p className="flex items-center gap-2">
            <span className="flex h-2 w-2 rounded-full bg-red-primary animate-pulse" />
            {error}
          </p>
        </div>
      )}
