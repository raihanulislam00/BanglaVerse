                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <div className="space-y-4 text-center">
                    <p className="text-gray-600">
                      ...
                      <Link to="/sign-up" className="text-green-primary hover:text-green-dark hover:underline font-medium transition-colors">
                        Sign Up
                      </Link>
                    </p>
                    <Link
                      to="/forgot-password"
                      className="block text-red-primary hover:text-red-dark hover:underline font-medium transition-colors"
                    >
